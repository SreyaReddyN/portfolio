...
- **Data Analysis & Statistics**: Microsoft Excel (Advanced Formulas, Functions, Pivot Tables, VBA exposure), SQL, Python (pandas, NumPy), R; Statistical methods including ANOVA, t-tests, Time Series Forecasting, A/B Testing, Hypothesis Testing
- **Programming**: Python (Scikit-Learn, NumPy, Pandas, NLTK, TensorFlow, PyTorch), R (tidyverse, ggplot2, dplyr), C, C++, C#, Java
- **ML & AI**: Regression, Classification, Predictive Modeling, NLP(TF-IDF), Decision Trees, KNN, Deep Learning (TensorFlow, PyTorch), SVM, Random Forest, XGBoost, clustering, CNN, RNN,LLM
- **Data Visualization & Reporting**: Tableau, Power BI, Matplotlib, Seaborn
- **Databases & Data Warehousing**: Relational: MySQL, PostgreSQL, Oracle DB, MariaDB; NoSQL: MongoDB, Cassandra; Cloud Warehousing: Snowflake
- **Cloud & ETL**: GCP(BigQuery), AWS (S3, Glue), Azure (DevOps, Data Lake), Databricks, SnapLogic, Informatica, Azure Data Factory


### Education

**Master's in Data Science** | **University Of Colorado Boulder, USA** | Aug 2025 - May 2027

**Bachelor of Technology in Computer Science and Engineering**  | **CMR Institute of Technology (VTU), India** | Aug 2019 - May 2023
